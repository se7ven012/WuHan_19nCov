...
# read from txt file
f = open("C:/Users/se7ven011/Desktop/WuHan_19nCov-master/1579860242.txt", "r")
raw = f.read()
...
export_csv = df.to_csv (r'C:/Users/se7ven011/Desktop/WuHan_19nCov-master/'+str(ts)+'.csv', index = None, header=True)
